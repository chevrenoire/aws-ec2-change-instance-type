...
read -p "Enter the region to use: " AWS_REGION
# Enable SUBNET_ID for test_change_ec2_instance_type.sh script to work if your instances are not in the default VPC.
# You must then set the SUBNET_ID variable to the subnet ID of your instances.
# SUBNET_ID is already set in the test_change_ec2_instance_type.sh script where necessary to run.
